...
const Signup = () => {
  ...
  const postDetails = (pics) => {
    ...
    if (pics.type === "image/jpeg" || pics.type === "image/png") {
      ...
      data.append("cloud_name", "dvf43atmj");
      fetch("https://api.cloudinary.com/v1_1/dvf43atmj/image/upload", {
        method: "post",
        body: data,
      })
        .then((res) => res.json())
  ...
  return (
    <VStack spacing="5px">
      <FormControl id="first-name" isRequired textColor="white">
      ...
      <FormControl id="pic" textColor="white">
